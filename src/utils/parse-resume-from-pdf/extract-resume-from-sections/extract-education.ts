...
import { ResumeEducation } from '../resume-types';
...
export const extractEducation = (sections: ResumeSectionToLines) => {
  ...
  // Broader keyword matching for education sections
  const lines = getSectionLinesByKeywords(sections, ['education', 'academic', 'qualification', 'degree']);
